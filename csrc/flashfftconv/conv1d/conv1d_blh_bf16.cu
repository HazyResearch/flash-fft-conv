...
__forceinline__ __device__ __nv_bfloat162 _conv1d_k_3(const __nv_bfloat162* u, const __nv_bfloat162* weights, const __nv_bfloat162* bias, __nv_bfloat162* out, uint padding, uint b, uint l, uint d, uint t, uint L, uint D, uint K, uint L_eff, uint L_out)
{

    __nv_bfloat162 temp_sum = bias[d];
...
__global__ void conv1d_kernel_k_3(
    ...
    const __nv_bfloat162 *__restrict__ weights,
