    ...
    uint sqrt_N)
{
    ...
    {
        return monarch_conv_cuda(x, k_f, f_sqrt_N_fft, twiddle_factors_fft, f_sqrt_N_ifft, twiddle_factors_ifft, in_gate, out_gate, fftsize, N, sqrt_N);
    }
    else if (x.dtype() == torch::kBFloat16)
    {   
        return monarch_conv_cuda_bf16_all(x, k_f, f_sqrt_N_fft, twiddle_factors_fft, f_sqrt_N_ifft, twiddle_factors_ifft, in_gate, out_gate, fftsize, N, sqrt_N);
    }
    else
    {
...
torch::Tensor monarch_conv_16_16_16(
    torch::Tensor x,
    torch::Tensor k_f,
    torch::Tensor f_sqrt_N_fft,
    torch::Tensor twiddle_factors_256_fft,
    ...
    uint sqrt_N_16)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_16_16_16(x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
    }
    else if (x.dtype() == torch::kBFloat16)
    {   
        if (f_sqrt_N_fft.dtype() == torch::kBFloat16) {
            return monarch_conv_cuda_16_16_16_bf16_all(x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
        } else {
            return monarch_conv_cuda_16_16_16_bf16(x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
        }
    }
    else
    {
...
torch::Tensor monarch_conv_32_16_16(
    torch::Tensor x,
    torch::Tensor k_f,
    torch::Tensor f_32_fft,
    torch::Tensor f_16_fft,
    ...
    uint N)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_32_16_16(
            x, k_f, 
            f_32_fft, f_16_fft,
    ...
    {   
        // if (false) {
        if (f_32_fft.dtype() == torch::kBFloat16) {
            return monarch_conv_cuda_32_16_16_bf16_all(
                x, k_f, 
                f_32_fft, f_16_fft,
                twiddle_factors_N_fft, twiddle_factors_16_fft,
                f_32_ifft, f_16_ifft,
            ...
            return monarch_conv_cuda_32_16_16_bf16(
                x, k_f, 
                f_32_fft, f_16_fft,
                twiddle_factors_N_fft, twiddle_factors_16_fft,
                f_32_ifft, f_16_ifft,
...
torch::Tensor monarch_conv_16_32_32(
    torch::Tensor x,
    torch::Tensor k_f,
    torch::Tensor f_16_fft,
    torch::Tensor f_32_fft,
    ...
    uint N)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_16_32_32(
            x, k_f, 
            f_16_fft, f_32_fft,
    ...
    {   
        return monarch_conv_cuda_16_32_32_bf16_all(
            x, k_f, 
            f_16_fft, f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_16_ifft, f_32_ifft,
...
torch::Tensor monarch_conv_32_32_32(
    torch::Tensor x,
    torch::Tensor k_f,
    torch::Tensor f_32_fft,
    torch::Tensor twiddle_factors_N_fft,
    ...
    uint N)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_32_32_32(
            x, k_f, 
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_32_ifft,
    ...
    {   
        return monarch_conv_cuda_32_32_32_bf16_all(
            x, k_f, 
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_32_ifft,
