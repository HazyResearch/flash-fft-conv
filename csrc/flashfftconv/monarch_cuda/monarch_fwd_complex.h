...
std::pair<torch::Tensor, torch::Tensor> monarch_conv_16_16_16_complex(
    torch::Tensor x_real,
    torch::Tensor x_imag,
    torch::Tensor k_f,
    ...
    uint N)
{
    ...
    TORCH_CHECK(f_sqrt_N_fft.is_contiguous());
    TORCH_CHECK(twiddle_factors_256_fft.is_contiguous());
    TORCH_CHECK(twiddle_factors_16_fft.is_contiguous());
    TORCH_CHECK(f_sqrt_N_ifft.is_contiguous());
    TORCH_CHECK(twiddle_factors_256_fft.is_contiguous());
    TORCH_CHECK(twiddle_factors_16_ifft.is_contiguous());
    ...
    CHECK_SHAPE(f_sqrt_N_fft, 16, 16, 2);
    CHECK_SHAPE(twiddle_factors_16_fft, 16, 16, 2);
    CHECK_SHAPE(twiddle_factors_256_fft, 16, 256, 2);
    CHECK_SHAPE(f_sqrt_N_ifft, 16, 16, 2);
    CHECK_SHAPE(twiddle_factors_16_ifft, 16, 16, 2);
    CHECK_SHAPE(twiddle_factors_256_ifft, 16, 256, 2);

    if (x_real.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_16_16_16_complex(
            x_real, x_imag, k_f, 
            f_sqrt_N_fft,
            twiddle_factors_256_fft, twiddle_factors_16_fft,
            f_sqrt_N_ifft,
            twiddle_factors_256_ifft, twiddle_factors_16_ifft,
            fftsize, N);
    }
    else if (x_real.dtype() == torch::kBFloat16)
    {   
        return monarch_conv_cuda_16_16_16_complex_bf16_all(
            x_real, x_imag, k_f, 
            f_sqrt_N_fft,
            twiddle_factors_256_fft, twiddle_factors_16_fft,
            f_sqrt_N_ifft,
...
std::pair<torch::Tensor, torch::Tensor> monarch_conv_32_16_16_complex(
    torch::Tensor x_real,
    torch::Tensor x_imag,
    torch::Tensor k_f,
    torch::Tensor f_32_fft,
    ...
    uint N)
{
    ...
    if (x_real.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_32_16_16_complex(
            x_real, x_imag, k_f, 
            f_32_fft,
            f_16_fft,
    ...
    {   
        return monarch_conv_cuda_32_16_16_complex_bf16_all(
            x_real, x_imag, k_f, 
            f_32_fft,
            f_16_fft,
            twiddle_factors_N_fft, twiddle_factors_16_fft,
...
std::pair<torch::Tensor, torch::Tensor> monarch_conv_16_32_32_complex(
    torch::Tensor x_real,
    torch::Tensor x_imag,
    torch::Tensor k_f,
    torch::Tensor f_16_fft,
    ...
    uint N)
{
    ...
    if (x_real.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_16_32_32_complex(
            x_real, x_imag, k_f, 
            f_16_fft,
            f_32_fft,
    ...
    {   
        return monarch_conv_cuda_16_32_32_complex_bf16_all(
            x_real, x_imag, k_f, 
            f_16_fft,
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
...
std::pair<torch::Tensor, torch::Tensor> monarch_conv_32_32_32_complex(
    torch::Tensor x_real,
    torch::Tensor x_imag,
    torch::Tensor k_f,
    torch::Tensor f_32_fft,
    ...
    uint N)
{
    ...
    if (x_real.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_32_32_32_complex(
            x_real, x_imag, k_f, 
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_32_ifft,
    ...
    {   
        return monarch_conv_cuda_32_32_32_complex_bf16_all(
            x_real, x_imag, k_f, 
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_32_ifft,
...
std::pair<torch::Tensor, torch::Tensor> monarch_conv_32_32_32_complex_truncated(
    torch::Tensor x_real,
    torch::Tensor x_imag,
    torch::Tensor k_f,
    torch::Tensor f_32_fft,
    ...
    uint kernel_trunc)
{
    ...
    if (x_real.dtype() == torch::kFloat16)
    {
        return monarch_conv_cuda_32_32_32_complex_truncated(
            x_real, x_imag, k_f, 
            f_32_fft,
            twiddle_factors_N_fft, twiddle_factors_32_fft,
            f_32_ifft,
