    ...
    uint sqrt_N)
{
    ...
    {
        return monarch_conv_bwd_cuda(dout, x, k_f, f_sqrt_N_fft, twiddle_factors_fft, f_sqrt_N_ifft, twiddle_factors_ifft, in_gate, out_gate, fftsize, N, sqrt_N);
    }
    else if (x.dtype() == torch::kBFloat16)
    {
        return monarch_conv_bwd_cuda_bf16_all(dout, x, k_f, f_sqrt_N_fft, twiddle_factors_fft, f_sqrt_N_ifft, twiddle_factors_ifft, in_gate, out_gate, fftsize, N, sqrt_N);
    }
    else
    {
    ...
    uint sqrt_N_16)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_bwd_cuda_16_16_16(dout, x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
    }
    else if (x.dtype() == torch::kBFloat16)
    {
        if (f_sqrt_N_fft.dtype() == torch::kBFloat16) {
            return monarch_conv_bwd_cuda_16_16_16_bf16_all(dout, x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
        } else {
            return monarch_conv_bwd_cuda_16_16_16_bf16(dout, x, k_f, f_sqrt_N_fft, twiddle_factors_256_fft, twiddle_factors_16_fft, f_sqrt_N_ifft, twiddle_factors_256_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N, sqrt_N_16);
        }
    }
    else
    {
    ...
    uint N)
{
    ...
    if (x.dtype() == torch::kFloat16)
    {
        return monarch_conv_bwd_cuda_32_16_16(
            dout, x, k_f,
            f_32_fft, f_16_fft, twiddle_factors_N_fft, twiddle_factors_16_fft, f_32_ifft, f_16_ifft, twiddle_factors_N_ifft, twiddle_factors_16_ifft, in_gate, out_gate, fftsize, N);
    }
    else if (x.dtype() == torch::kBFloat16)
    {
        // if (true) {
