...
class BertLayer(nn.Module):
    ...
    def __init__(self, config):
        ...
        if config.use_flashfftconv:
            from monarch_mixer_sequence_mixer_flashfftconv import MonarchMixerSequenceMixingFlashFFTConv
            mm_cls = MonarchMixerSequenceMixingFlashFFTConv
        else:
    ...
    def __init__(self, config):
        ...
        if config.use_flashfftconv:
            for layer in self.layer:
                layer.attention.flashfftconv = self.flashfftconv 
